...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        MyTopicDao.createTable(db, ifNotExists);
        IgnoredRepoDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        MyTopicDao.dropTable(db, ifExists);
        IgnoredRepoDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(MyTopicDao.class);
        registerDaoClass(IgnoredRepoDao.class);
    }
